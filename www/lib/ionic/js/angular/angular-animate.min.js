...
(function (N, f, W) {
    ...
    f.module("ngAnimate", ["ng"]).directive("ngAnimateChildren",function () {
        ...
        X.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function (O, N, M, Y, y, H, P, W, Z, Q) {
            ...
            function U(a, c, b, d) {
                ...
                if (l) {
                    ...
                    if (x(p)) {
                        ...
                        return{node: l, event: c, className: b, isClassBased: E, isSetClassOperation: w, applyStyles: function () {
            ...
            return{animate: function (a, c, b, d, h) {
        ...
        C.register("", ["$window", "$sniffer", "$timeout", "$$animateReflow", function (r, C, M, Y) {
            ...
            function R(b, e, c, d) {
                ...
                e.data("$$ngAnimateCSS3Data", {stagger: m, cacheKey: p, running: n.running || 0, itemIndex: h, blockTransition: c, closeAnimationFns: n.closeAnimationFns || []});
                p = g(e);
                c && (I(p, !0), d && e.css(d));
            ...
            return{animate: function (a, b, c, d, f, g) {
                g = g || {};
                g.from = c;
                g.to = d;
